...
const PortfolioPDF = () => {
  return (
    <div id="pdf-template" className="w-full border border-gray-200 shadow-lg">
      <div
        className="flex p-6 justify-between items-center border-b pb-4"
      ...
      <div className="p-6 mt-6 bg-white-100">
