...
const ProfileIntroSkeleton = () => {
  return (
    <div className="p-[40px] flex flex-col justify-center items-center bg-white-100 border border-slate-90 rounded-xlarge shadow-sm">
      <div className="text-xlarge font-lg text-slate-30">
