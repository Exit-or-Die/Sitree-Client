...
const ProfileCareerSection = ({ careers }: Props) => {
  return (
    <div className="p-[40px] bg-white flex flex-col bg-white-100 border border-slate-90 rounded-xlarge shadow-sm">
      <div className="text-xlarge font-lb text-slate-10">경력 0년 0개월</div>
        ...
        return (
          <div key={index}>
            <div className="flex items-start mt-[20px] mb-6">
              ...
              <div className="ml-4">
                <h3 className="text-large font-lb">{career.careerName}</h3>
                <div className="flex items-center">
                  <div className="text-small text-slate-30 font-lb">{career.position}</div>
