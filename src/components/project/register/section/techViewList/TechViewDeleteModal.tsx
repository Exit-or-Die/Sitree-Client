...
interface TechViewDeleteModalProps {
  onClickClose: () => void;
  deleteTechView: () => void;
}

const TechViewDeleteModal = ({ onClickClose, deleteTechView }: TechViewDeleteModalProps) => {
  return (
    <div className="px-6 bg-white-100 rounded-[2.4rem] text-small text-start w-[36rem]">
      ...
      <div className="py-4 flex justify-end gap-2">
        ...
        <SButton onClick={deleteTechView} className="border-none bg-slate-20 text-white-100">
          삭제하기
        </SButton>
      </div>
    </div>
...
export default TechViewDeleteModal;
